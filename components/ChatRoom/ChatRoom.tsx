    ...
    <div className={styles.chat_room_container} id="chatRoom">
      <div className={styles.chat_room_header}>
        ...
        <Image
          ...
          layout="fixed"
        />
        <p className={styles.contact_name}>{props.currentRoom != "" ? props.currentRoom : "Abre un chat"} {(props.typing.split(" is ")[0] === props.currentRoom && props.typing.split(" is ")[1] != undefined) && `is ${props.typing.split(" is ")[1]}`}</p>
      </div>
